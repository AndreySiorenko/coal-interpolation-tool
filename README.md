...
- Автоматический анализ пространственного распределения
- Определение оптимального метода интерполяции
- Расчет параметров на основе характеристик данных
...
---
**Текущая версия**: 0.7.0 - Полноценная 2D визуализация и GUI  
